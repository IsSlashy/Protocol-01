...
pub fn generate_compact_proof_with_pair_indexing(
    ...
    for &pos in &positions {
        ...
        let merkle_path = get_merkle_proof_pair(&tree, pos & (t_half - 1));
        let next_merkle_path = get_merkle_proof_pair(&tree, next_pos & (t_half - 1));
...
struct CompactQuery {
    ...
    merkle_path: [[u8; 32]; MERKLE_DEPTH - 1],
    next_merkle_path: [[u8; 32]; MERKLE_DEPTH - 1],
