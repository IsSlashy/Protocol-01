...
> **Note, 2026-09-14.** This document is a dated archive. The programs `p01_fee_splitter`, `specter` it names were closed on devnet on 2026-09-13 (`docs/HANDOFF-2026-09-13.md` §11).
