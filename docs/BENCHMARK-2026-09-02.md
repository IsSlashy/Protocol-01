...
| note-in exchange (2026-09-03): shield, withdraw to the till, claim, collect an older note | 522 s for the three chain steps, then 13 s to collect | 27DYPdwM… → 3FnRiSvL… → an older treasury note |
