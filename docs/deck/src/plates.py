...
<table>
  ...
  <tr><td class="k">Pool</td><td>73 deposited, 26 spent, 47 unspent</td><td>1 SOL pool, read 22 August. The 0.1 SOL pool is closed at 41 leaves, 12 unspent, read 21 August.</td></tr>
...
<ul class="none">
  ...
  <li><strong>Deposit to withdraw linkage is possible.</strong> Every deployed spend republishes the commitment its deposit already published, so matching the two is trivial for an observer. The crowd of 47 unspent notes is a ceiling; the effective size today is one. C7 is the work that closes it.</li>
