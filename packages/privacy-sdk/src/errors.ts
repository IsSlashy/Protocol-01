export enum PrivacyErrorCode {
  ...
  // ─── Exchange / Mugen (11xxx) ──────────────────────────────────────
  EXCHANGE_ORDER_NOT_FOUND = 11001,
  EXCHANGE_ORDER_EXPIRED = 11002,
  EXCHANGE_ORDER_NOT_OPEN = 11003,
  EXCHANGE_ESCROW_NOT_FOUND = 11004,
  EXCHANGE_ESCROW_EXPIRED = 11005,
  EXCHANGE_ATTESTATION_REQUIRED = 11006,
  EXCHANGE_ATTESTATION_EXPIRED = 11007,
  EXCHANGE_UNAUTHORIZED = 11008,
  EXCHANGE_TAKE_FAILED = 11009,
  EXCHANGE_RELEASE_FAILED = 11010,
  EXCHANGE_DISPUTE_FAILED = 11011,
}
