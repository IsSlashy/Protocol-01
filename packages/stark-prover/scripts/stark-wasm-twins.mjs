 ...
 *
 *   node packages/stark-prover/scripts/stark-wasm-twins.mjs --check    # exit 1 on any drift  (CI gate)
 ...
 *
 * AUTO-GENERATED by \`packages/stark-prover/scripts/stark-wasm-twins.mjs --write\`. Do not edit by hand.
...
for (const twin of TWINS) {
  ...
  console.error(
    `[stark-wasm-twins] DRIFT ${twin.path}: decodes to ${decoded.length.toLocaleString()} bytes, ` +
      ...
      `packages/stark-prover/wasm/. Fix with: node packages/stark-prover/scripts/stark-wasm-twins.mjs --write`,
  );
  failures += 1;
}
