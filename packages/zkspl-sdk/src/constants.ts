...
// ⛔ ZKSPL_PROGRAM_ID below (and PROGRAM_IDS[*].zkspl) is a DECLARED id from
// Anchor.toml. The p01_zkspl program is NOT deployed on devnet or mainnet
// (root README, 2026-09-23; audit v1 F46): transactions to it fail. The
// generated JSDoc "Deployed p01_zkspl program ID (devnet)" inside the block is
// stale: it comes from scripts/sync-program-ids.ts (zksplSdkBlock), so a hand
// edit there would be undone by the next `pnpm sync-program-ids --write`.
// Fixing the wording belongs in that generator.
