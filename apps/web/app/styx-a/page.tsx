...
/* One serif voice for statements. Body stays on Inter, evidence on JetBrains
   ...
   Newsreader is a variable face: the weight axis is the point of it here. The
   display line runs light and large, section titles sit at 400, and small
   serif (facts, step titles) gets 500 so it does not go spindly at 1.4rem.
   Instrument Serif shipped a single 400 and could do none of that. */
