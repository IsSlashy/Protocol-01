export default {
  ...
  onboarding: {
    ...
    lede: 'Vos clés naissent sur ce téléphone et n’en sortent pas. Des tokens de test sur devnet, pas de vrais fonds.',
    devnetTag: 'Devnet seulement',
    devnetLine: 'Des tokens de test, pas de vrais fonds. Non audité.',
    crossing: 'La traversée',
    yourAddress: 'Votre adresse',
    walletReady: 'Votre portefeuille est sur ce téléphone.',
    ...
    encryptedSecurity: 'Clés créées sur ce téléphone, gardées dans son stockage sécurisé.',
