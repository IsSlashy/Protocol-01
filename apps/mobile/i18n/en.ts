export default {
  ...
  settings: {
    ...
    aboutDescription: 'Protocol 01 is a privacy-focused Solana wallet. It uses STARK proofs and stealth addresses (ECDH + ML-KEM) to protect your financial privacy.',
