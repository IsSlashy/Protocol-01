 ...
 *
 * Runs under the extension's vitest config (jsdom).
 */
...
describe('fetchPoolLeavesByIndex routing', () => {
  ...
  it('resolves no base URL under vitest unless VITE_P01_WEB_URL names the site', () => {
    expect(resolvePoolLeavesBaseUrl()).toBeNull();
    vi.stubEnv('VITE_P01_WEB_URL', 'https://protocol-01.dev/');
    try {
