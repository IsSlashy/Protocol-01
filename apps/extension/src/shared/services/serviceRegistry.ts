...
export const CATEGORY_CONFIG: Record<ServiceCategory, { icon: string; color: string; label: string }> = {
  streaming: { icon: 'Play', color: '#E50914', label: 'Streaming' },
  music: { icon: 'Music', color: '#1DB954', label: 'Music' },
  ai: { icon: 'Bot', color: '#412991', label: 'AI Services' },
  gaming: { icon: 'Gamepad2', color: '#107C10', label: 'Gaming' },
  saas: { icon: 'Briefcase', color: '#000000', label: 'SaaS' },
  news: { icon: 'Newspaper', color: '#000000', label: 'News & Media' },
  fitness: { icon: 'Dumbbell', color: '#FC4C02', label: 'Fitness' },
  storage: { icon: 'Cloud', color: '#0061FF', label: 'Storage' },
  vpn: { icon: 'Shield', color: '#4687FF', label: 'VPN & Security' },
  education: { icon: 'GraduationCap', color: '#5624D0', label: 'Education' },
  productivity: { icon: 'Target', color: '#7B68EE', label: 'Productivity' },
  communication: { icon: 'MessageCircle', color: '#5865F2', label: 'Communication' },
  other: { icon: 'CreditCard', color: '#666666', label: 'Other' },
};
 ...
 */
export function searchServices(query: string, limit = 5): ServiceInfo[] {
