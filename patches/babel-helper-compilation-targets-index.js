...
// lru-cache v10+ changed the export shape from a class to { LRUCache }.
// Support both so this Babel helper keeps working when v11+ is hoisted.
var _lruCacheRaw = require("lru-cache");
var _lruCache = typeof _lruCacheRaw === 'function' ? _lruCacheRaw : (_lruCacheRaw.LRUCache || _lruCacheRaw.default);
