...
// glob v13 exports __esModule:true with no default property,
// so _interopRequireDefault leaves _glob.default undefined.
// Re-wrap so _glob.default points to the actual glob namespace.
var _globRaw = require("glob");
var _glob = { default: (_globRaw && _globRaw.default) ? _globRaw.default : _globRaw };
